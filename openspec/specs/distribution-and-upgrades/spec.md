# distribution-and-upgrades Specification

## Purpose
Define the supported release application, platforms, installers, lifecycle operations, provenance, signing, and publication gate for Cadder 1.0.
